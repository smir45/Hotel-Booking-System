            ...
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                <div className="grid gap-10 lg:grid-cols-2">
                    <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
                        <div
                            className="flex items-center justify-center w-20 h-20 mb-4 rounded-full bg-teal-accent-400 transition-all ">
                ...
                Vacation
                            ...
                            <p className="text-base text-gray-700 md:text-lg">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam, explicabo minus nobis
                                consequuntur corporis, earum officia repellat id, sapiente incidunt aliquam doloremque
                                blanditiis dignissimos! Ipsa corporis sint minima totam ad!
                            </p>
                        </div>
                        <div>
                            <a
