        ...
        <div className=" w-96 rounded-2xl my-5 shadow-lg">
          <div>
            <img
              ...
              src="https://images.unsplash.com/photo-1544865267-c9e6d003f2ac?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80"
              alt="img"
            />
          </div>
