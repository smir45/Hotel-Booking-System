...
const hotelId = ({ item }) => {
  ...
  localStorage.setItem(
    "hotel_address_city",
    item.Addresses.map((address, index) => address.city)
  );
  localStorage.setItem(
    "hotel_address_street",
    item.Addresses.map((address, index) => address.country)
  );
      ...
      <div>
        <div className="w-full mt-5">
          <div className=" w-10/12 mx-auto my-5">
            <Carousel animation={"slide"} duration={500} indicators={true}>
            {item.images.map((img) => {
                return (
                    <img
                    src={img.name}
                    className=" mx-auto bg-pmry w-[80vw] h-[65vh]"
                    />
                );
            })}
            </Carousel>
                ...
                {item.Rooms.map((room, index) => {
                  return (
                    <div className="bg-blue-50 p-5">
                      <p className="font-bold px-2 text-primary text-2xl">
                        Room Description
                      </p>
                      <div>
                        <span>
                          ...
                          <span className="flex">
                            <p className="font-bold mx-2">
                              Number of Beds
                              <br />
                              <span className="font-light">{room.beds}</span>
                            </p>
                            <p className="font-bold border-l-2 px-5 border-r-2 ">
                              Non-refundable
                            </p>
                            ...
                            <p className="font-bold px-5 border-l-2 mx-2">
                              Price per Night:
                            </p>
                            <p className="flex">
                              {" "}
