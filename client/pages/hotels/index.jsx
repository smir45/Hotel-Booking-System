                                ...
                                <FaMapMarkerAlt/>
                              </span>
                                                            {
                                                                [hotel.Addresses.map((address, index) => (
                                                                    <p key={index}>{address.city}{", "}{address.country}</p>
                                                                ))]
                                                            }
                            </span>
                                                    </div>
                                                    <div className="flex">
                                                        ...
                                                        <div
                                                            className="bg-pmry p-2 text-white rounded-br-lg rounded-t-lg mx-2 my-1">
                                                            <p className="text-gray-500 font-bold text-lg">
                                                                {/* {hotel.review_score} */}
                                                            </p>
                                                        </div>
                                                ...
                                                >
                          {[...Array(hotel.hotel_reviews[0].stars)].map((e, i) => (
                              <span key={i}>
                              <FaStar/> <br/>
                            </span>
                          ))}
