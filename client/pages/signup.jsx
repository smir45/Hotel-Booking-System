    ...
    <div class="flex flex-col lg:flex-row">
        <div class="relative w-full bg-cover lg:w-6/12 xl:w-7/12 bg-gradient-to-r from-white via-white to-gray-100">
            <div class="relative flex flex-col items-center justify-center w-full h-full px-10 my-20 lg:px-16 lg:my-0">
                ...
                <img src="https://image.freepik.com/free-photo/funny-3d-cartoon-casual-character_183364-80223.jpg" alt="" />
            </div>
        </div>
        ...
        <div class="w-full bg-white lg:w-6/12 xl:w-5/12">
            ...
            <div class="flex flex-col items-start justify-start w-full h-full p-10 lg:p-16 xl:p-24">
                ...
                <p class="text-lg text-gray-500">or, if you have an account you can <a href="/login" class="text-primary underline">sign in</a></p>
                <div class="relative w-full mt-10 space-y-8">
                    <div class="relative">
                        {/* <label class="font-medium text-gray-900">Name</label> */}
                        <input onChange={(e) => handleChange(e)} type="text" class="block w-full px-4 py-4 mt-2 text-xl placeholder-gray-400 bg-gray-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-pmry focus:ring-opacity-50" name="name" placeholder="Enter Your Name" id="name"/>
                    </div>
                    <div class="relative">
                        {/* <label class="font-medium text-gray-900">Email</label> */}
                        <input onChange={(e) => handleChange(e)} type="text" class="block w-full px-4 py-4 mt-2 text-xl placeholder-gray-400 bg-gray-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-pmry focus:ring-opacity-50" name="email" placeholder="Enter Your Email Address" id="email" />
                    </div>
                    <div class="relative">
                        {/* <label class="font-medium text-gray-900">Password</label> */}
                        <input onChange={(e) => handleChange(e)} type="password" class="block w-full px-4 py-4 mt-2 text-xl placeholder-gray-400 bg-gray-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-pmry focus:ring-opacity-50" name="password" placeholder="Password" id="password"/>
                    </div>
